...
<Image width="1000" src={app} alt="screenshot of my board game app with statistics"/>
...
<Image width="400" src={senjutsu} alt="diagrams of a senjutsu fight how it could be animated"/>
