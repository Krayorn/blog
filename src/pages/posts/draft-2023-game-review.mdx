...
import wounds from '../../images/recap2023/wounds.png';
...
<Image 
    src={mhw} 
    class="img-50"
    alt="my stats for Monster Hunter World"
/>
...
<Image 
    src={monster} 
    class="img-25"
    alt="Winrate and number of hunters killed by each monster"
/>

Some monsters seem deadlier than others - Tobi Kadachi, looking at you, what happened? - and almsot all of them managed to kill some hunters each time. But for now, they still get slaughtered a lot. We will see how it changes once we encounter their bigger version (I will probably need another custom field to differenciate these data).
...
I wanted to include Senjutsu in this recap with its own section because despite arriving very late last year, I've played it quite a bit with 6 games! I've won the 3 games against friends, and 2 out of 3 against the AI in solo mode.
...
There isn't enough data to make some fun stat, but here is one because why not: the average of wounds suffered by each player across all the games they've played.

<Image 
    src={wounds} 
    class="img-25"
    alt="Average of wounds suffered by players in their Senjutsu games"
/>
...
That's enough for the screenshots, I need more views on my app to explore all this data!
Let's now talk about some games I didn't play enough of last year but want to bring to the table more often this year! 

Being Received only in December, I didn't have that much time to enjoy Tales Of the Rift, but the two games I did were a blast, and I hope to get many more games soon. 
