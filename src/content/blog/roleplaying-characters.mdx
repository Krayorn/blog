---
title: I'm not playing only badass female characters in TTRPG
description: desperately trying to prove I'm not playing only female badass characters in TTRPG
pubDate: 2025-08-19
tags:
  - RPG
---

import { Counter } from '../../components/Posts/Counter.jsx';
...
<Counter label={"Badass characters counter"} count={1} />
<Counter label={"Female characters counter"} count={0} />
...
<Counter label={"Badass characters counter"} count={2} />

<Counter label={"Female characters counter"} count={1} />

<Counter label={"DM gasping when seeing the lethality of the build counter"} count={1} />

### Lucia Elvira, Cops - 4 20h weekends
Time played: 5 weekends with 20+ hours of gaming (yes, it's amazing).
...
<Counter label={"Badass characters counter"} count={3} />

<Counter label={"Female characters counter"} count={2} />

<Counter label={"DM gasping when seeing the lethality of the build counter"} count={2} />
...
<Counter label={"Badass characters counter"} count={4} />
<Counter label={"Female characters counter"} count={2} />
...
<Counter label={"Badass characters counter"} count={5} />
<Counter label={"Female characters counter"} count={2} />

<Counter label={"DM gasping when seeing the lethality of the build counter"} count={3} />
...
<Counter label={"Badass characters counter"} count={5} />
<Counter label={"Female characters counter"} count={3} />
...
<Counter label={"Badass characters counter"} count={6} />
<Counter label={"Female characters counter"} count={4} />

<Counter label={"DM gasping when seeing the lethality of the build counter"} count={4} />
### Voggin, D&D 5e
...
<Counter label={"DM gasping when seeing the lethality of the build counter"} count={5} />
### Lei Kuanghu, Qin
...
<Counter label={"Badass characters counter"} count={7} />
<Counter label={"Female characters counter"} count={4} />

<Counter label={"DM gasping when seeing the lethality of the build counter"} count={6} />
### Gardien, D&D 5e
Time played: 2-3 4h sessions.
...
<Counter label={"DM gasping when seeing the lethality of the build counter"} count={7} />
...
<Counter label={"Badass characters counter"} count={8} />
<Counter label={"Female characters counter"} count={4} />
...
Characters that will physically beat you up counter = 9,5