---
title: 'Warhammer 40K Army project - Part 1: Symfony Of Suffering'
description: 'Follow along as I build my first warhammer 40k army. In this post, the army selection, and the first squad painted!'
pubDate: 2025-04-10
tags: ["warhammer"]
---
...
import boxes from '../../images/warhammer/boxes.jpeg';
import build1 from '../../images/warhammer/build1.jpeg';
import build2 from '../../images/warhammer/build2.jpeg';
import cork from '../../images/warhammer/cork.jpeg';
import cork2 from '../../images/warhammer/cork2.jpeg';
import paint1 from '../../images/warhammer/paint1.jpeg';
import paint2 from '../../images/warhammer/paint2.jpeg';
import paint3 from '../../images/warhammer/paint3.jpeg';
import paint4 from '../../images/warhammer/paint4.jpeg';


I've been thinking about getting back into 40K for quite some time, I had some necrons as a kid, but now I wanted a proper army. My old roomates got quite hyped as well and we decided to go for it. 
...
I really liked the Drukhari boats and the Incubi and the idea of playing quite mobile embarked troops, strong enough to take on anything that stand in front of them in a bloody melee was quite endearing. I was not that excited about the covens miniatures however.
...
They're not enhanced like those boring space marines...(I actually like marines as well, but my roomates ended up with ultramarines and grey knights so I must take jabs at them before they wipe my units), and therefore are super squishy (Toughness 3, 1 wound, if you look at them wrong, they might die). 

But if you managed to preserve them long enough to reach the enemy, they'll take out some tough opponents before dying in the next turn. Wether it's Repentias in close combat, or Seraphims with their 4 hand flamers.

So it was time to buy the first boxes!

I started by getting a box of the Sacresants and one of the Zephyrim, which was a little ambitious, it would have been wiser to take regular sisters to start but shortly after, even before I started building them, 3 buddy of mine got me a combat patrol box and Morvenn Vahl! 
...
In both game, my sisters couldn't kill their toughest units (terminators or a dreadnought), and they were dying left and right every time they got out of cover, but I had more units than them, which allowed me to keep control of most objectives and win both games by a thread! 


I then painted 2 of the sisters, trying to find my color scheme. 

Commiting to a paint scheme for an army is so much more intimidating than just painting board game miniatures. I'll have to paint a lot more minis in the same style, and they gotta look good on the battlefield!
...
It took me way more time than planned, but here they are:
...
I also kinda want to find a name for this order of sisters and some basic lore, could help me for the bases or some conversions!
