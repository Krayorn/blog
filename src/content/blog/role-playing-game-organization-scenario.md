...
The Loyalists would be the "balanced" faction, half puzzle / half social interactions.
The Mutineers would be the more social faction.
The Curseseekers would be the puzzle-focused faction.
...
I also wanted to incorporate a non-trivial logic puzzle, so I looked into [Zebra Puzzle](https://en.wikipedia.org/wiki/Zebra_Puzzle) and, after solving a few, made my own adapted for my setting.
...
The games were [Liar's Dice](https://en.wikipedia.org/wiki/Liar%27s_dice), [BlackRobert (Blackjack)](https://en.wikipedia.org/wiki/Blackjack), [Pitching pennies](https://en.wikipedia.org/wiki/Pitching_pennies) and [Osselets / Knucklebones](https://en.wikipedia.org/wiki/Knucklebones). Each NPC had tons of spare coins to inject into the game through those little activities.
